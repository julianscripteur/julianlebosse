--[[crée par juju le bg de la cité"
Discord:https://discord.gg/Sa8GyZNK
Dont change or u can get banned !!! not my fault if U get banned
--]]
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window  = Library.CreateLib("Script cree par julian54701", "BloodTheme")
local Tab     = Window:NewTab("Scripts")
local Section = Tab:NewSection("acheter des NFT (With Game Money!)")
...
Section:NewButton("achete munneh nft", "achete munneh nft", function()
    local args = {
        [1] = "Munneh"
    }
...
local Section = Tab:NewSection("pour crash le serveur"prend un auto cliker mais sur ca")
Section:NewButton("Crash le server", "Crash le server", function()
    local args = {
    [1] = "Jet"
    }
...
Section:NewKeybind("fermer F ouvrir F", "fermer F ouvrir F", Enum.KeyCode.F, function()
    Library:ToggleUI()
end)
Section:NewLabel("Teleporte toi au trade")
Section:NewButton("tp toi au trade 1", "ButtonInfo", function()
...
Section:NewButton("trade 2", "teleporte toi au trade 2", function()
...
Section:NewButton("tp au trade 3", "ButtonInfo", function()
...
Section:NewButton("tp au trade 4", "ButtonInfo", function()
...
Section:NewButton("tp au trade 5", "ButtonInfo", function()
...
Section:NewButton("tp au trade 6", "ButtonInfo", function()
...
Section:NewButton("tp au trade 7", "ButtonInfo", function()
...
local Section = Tab:NewSection("Duplique ton argent infini !")
Section:NewToggle("Auto Duplique the Banane", "dupe the banane", function(state)
    if state then
_G.on = true
...
Section:NewButton("Duplice pop it Rainbow", "il te faux 1,2 miliard pour dupe ca", function()
local args = {
        [1] = "Pop It Rainbow!"
    }
...
Section:NewButton("Duplique Lolly Rainbow", "il te fau 600 milion pour dupe ca", function()
local args = {
        [1] = "Lolly Rainbow"
    }
...
Section:NewButton("Duplique Amogus Rainbow", "il te fau 400 milion pour dupe ca", function()
local args = {
        [1] = "Amogus Rainbow"
    }
...
Section:NewButton("Duplique Crystal Rainbow", "il te fau 200 milion pour dupe ca", function()
local args = {
        [1] = "Crystal Rainbow"
    }
...
Section:NewButton("Duplique Slippy Rainbow", "il te faux 150 milion pour dupe ca", function()
local args = {
        [1] = "Slippy rainbow"
    }
...
Section:NewButton("Duplique banane rainbow", "il te fau 100milion pour dupe ca", function()
local args = {
        [1] = "Rainbow Banana"
    }
...
Section:NewButton("Duplique Gummy Rainbow", "il te faux 40miion pour dupe ca", function()
local args = {
        [1] = "Gummy Rainbow"
    }
...
Section:NewButton("Duplique Gem Rainbow", "il te fau 34milion pour dupe ca", function()
local args = {
        [1] = "Gem Rainbow"
    }
...
Section:NewButton("Duplique Muscles", "il te fau 30milion lola pour dupe ca", function()
local args = {
        [1] = "Muscles"
    }
...
Section:NewButton("Duplique Illuminati", "il te fau 22milion pour dupe ca lola", function()
local args = {
        [1] = "Illuminati"
    }
...
Section:NewButton("Duplique Jet", "il te fau 18 milion pour dupe ca lola", function()
local args = {
        [1] = "Jet"
    }
...
Section:NewButton("Duplique eTruck", "il te fau 10milion pour dupe ca lola", function()
local args = {
        [1] = "eTruck"
    }
...
Section:NewButton("Duplique areigner", "il te fau 3milion pour dupe ca lola", function()
local args = {
        [1] = "Shiny Thing"
    }
...
Section:NewButton("Duplique voiture tusla Rainbow", "il te fau 2milion pour dupe ca lola", function()
        [1] = "Tulsa rainbow"
    }
...
local Tab     = Window:NewTab("les script de l arnaque ")
local Section = Tab:NewSection("scam working !!")
Section:NewButton("arnaque 1V", "arnaque un peu nul le 2et mieux", function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/imaboy12321/shhh/main/gaey'),true))()
end)
Section:NewButton("arnaque 2V", "active toggle et att que quelqun saute sur le trade", function()
...
local Tab     = Window:NewTab("jeter des truc")
local Section = Tab:NewSection("jeter des chose :)")
Section:NewButton("drop une banane ", "appuis decuc", function()
...
Section:NewButton("jeter Ben", "jeter Ben", function()
getgenv().item_name = "Trading Ben" -- Change this to what you want to autodupe
loadstring(game:HttpGet('https://raw.githubusercontent.com/THEBESTHAGEG/LOLOLO/main/README.md'))()
end)
local Tab     = Window:NewTab("si on ta reaped click sur moi vend ta reaped")
local Section = Tab:NewSection("1.pour avoir de l argent vent ta reaper")
Section:NewButton("1.duplique un gumme blue", "tu dois avoir 200de argent", function()
local args = {
        [1] = "Gummy Blue"
    }
...
Section:NewButton("2.click sur moi pour dupe une echelle", "il te fau 1000argent", function()
local args = {
        [1] = "Ladder"
    }
...
Section:NewButton("3.click sur moi pour dupe un train tommeh", "il te fau 2500 de money lola", function()
local args = {
        [1] = "Bad Tommeh"
    }
...
Section:NewButton("4.click sur moi pour dupe un bitcoin", "tu dois avoir 50k de argent pour dupe ca", function()
local args = {
        [1] = "Bitcoin"
    }
...
Section:NewButton("5.click sur moi pour dupe un gummy noir je suis pas raciste", "tu dois avoir 50k de money", function()
local args = {
        [1] = "Gummy Black"
    }
    ...
    game:GetService("ReplicatedStorage").RemoteEvents.BuyItemCash:FireServer(unpack(args))
end)Section:NewButton("6.click sur moi pour dupe une boombox en bonbon", "il te fau 250k pour dupe ca", function()
local args = {
        [1] = "Boombox Candy"
    }
...
Section:NewButton("7.click sur moi pour dupe un siren head", "il te fau 1 milion pour dupe ca", function()
local args = {
        [1] = "Siren Head"
    }
...
Section:NewButton("8.une tusla rainbow vas sur dupe script pour dupe ca", "Buy item dupe cash", function()
local args = {
        [1] = "Tulsa rainbow"
    }
...
local Section = Tab:NewSection("Click sur Crash server pour ravoir tes item il te fau 18miliard pour clicker decuc !!!!")
Section:NewButton("si tu click ici avc ton auto cliker quand tu vas revenir t aura re tes item", "Click ici pour crash et ravoir tes item", function()
    local args = {
        [1] = "Jet"
    }
...
local Tab     = Window:NewTab("rois")
local Section = Tab:NewSection("cree par julian54701 le bg")
local Section = Tab:NewSection("le discord a ete sup par le mec :/")
